...
export async function runSetup(): Promise<void> {
  p.intro("Develooper Setup");

  p.note(
    "This wizard will help you configure Develooper.\n" +
      "You'll need:\n" +
  ...
  if (dirCheck.valid) {
    ...
    p.log.info("You can create this directory later. Develooper will scan it on startup.");
  }
  ...
  p.outro("Setup complete! Run `npm run dev` to start Develooper.");
}
